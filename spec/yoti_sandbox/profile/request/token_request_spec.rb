...
describe 'Sandbox::Profile::Request::TokenRequest' do
  let :value do
    'value'
  end
  let :anchors do
    [Sandbox::Profile::Request::Anchor.source('', timestamp: Time.utc(2007, 7, 6, 0, 0))]
  end
  describe '.with_given_names' do
    let :token_request do
      Sandbox::Profile::Request::TokenRequestBuilder.new.with_given_names(value, anchors: anchors).build
    end
  ...
  describe '.with_full_name' do
    let :token_request do
      Sandbox::Profile::Request::TokenRequestBuilder.new.with_full_name(value, anchors: anchors).build
    end
  ...
  describe '.with_family_name' do
    let :token_request do
      Sandbox::Profile::Request::TokenRequestBuilder.new.with_family_name(value, anchors: anchors).build
    end
  ...
  describe '.with_date_of_birth' do
    let :token_request do
      Sandbox::Profile::Request::TokenRequestBuilder.new.with_date_of_birth(Time.utc(2008, 7, 6, 0, 0), anchors: anchors).build
    end
  ...
  describe '.with_age_verification' do
    let :token_request do
      Sandbox::Profile::Request::TokenRequestBuilder.new.with_age_verification(
        dob: Time.utc(2008, 7, 6, 0, 0),
        derivation: Sandbox::Profile::Request::Derivation.age_over(21),
        anchors: anchors
      ).build
    end
  ...
  describe '.with_gender' do
    let :token_request do
      Sandbox::Profile::Request::TokenRequestBuilder.new.with_gender(value, anchors: anchors).build
    end
    it 'sets a gender' do
  ...
  describe '.with_phone_number' do
    let :token_request do
      Sandbox::Profile::Request::TokenRequestBuilder.new.with_phone_number(value, anchors: anchors).build
    end
  ...
  describe '.with_nationality' do
    let :token_request do
      Sandbox::Profile::Request::TokenRequestBuilder.new.with_nationality(value, anchors: anchors).build
    end
  ...
  describe '.with_postal_address' do
    let :token_request do
      Sandbox::Profile::Request::TokenRequestBuilder.new.with_postal_address(value, anchors: anchors).build
    end
  ...
  describe '.with_structured_postal_address' do
    ...
    let :token_request do
      Sandbox::Profile::Request::TokenRequestBuilder.new.with_structured_postal_address(data, anchors: anchors).build
    end
  ...
  describe '.with_selfie' do
    ...
    let :token_request do
      Sandbox::Profile::Request::TokenRequestBuilder.new.with_selfie(data, anchors: anchors).build
    end
  ...
  describe '.with_email_address' do
    let :token_request do
      Sandbox::Profile::Request::TokenRequestBuilder.new.with_email_address(value, anchors: anchors).build
    end
  ...
  describe '.with_document_details' do
    let :token_request do
      Sandbox::Profile::Request::TokenRequestBuilder.new.with_document_details(value, anchors: anchors).build
    end
  ...
  describe '.with_remember_me_id' do
    ...
    let :token_request do
      Sandbox::Profile::Request::TokenRequestBuilder.new.with_remember_me_id(id).build
    end
